def funcao_calculo_desconto(valor_unitario: float, quantidade: int) -> float:
    desconto = 1
    ...
    if __name__ == '__main__':
        ...
        valor_sem_desconto, valor_com_desconto = funcao_calculo_desconto(valor_unitario, quantidade)
